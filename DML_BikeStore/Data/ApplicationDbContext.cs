...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E271804E21F");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B409BB8255");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB8527300E16");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622945032516");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4273B2A97");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF55088FEF9");
        ...
        {
            entity.HasKey(e => e.ChangeId).HasName("PK__product___F4EFE596A8D83C49");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C34C8641B");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61643D71724F").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3FAFB9E9B");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C965E0E54");
